...
class CreatePayment(KhipuService):
    ...
    def __init__(self, receiver_id, secret, service_name, **kwargs):
        super(CreatePayment, self).__init__(receiver_id, secret, service_name, **kwargs)
        self.method = 'POST'
        self.path = 'payments'
        fields = [
        ...
        if kwargs.get('amount') and kwargs.get('currency') and kwargs.get('subject'):
...
class GetPayment(KhipuService):
    ...
    def __init__(self, receiver_id, secret, service_name, **kwargs):
        super(GetPayment, self).__init__(receiver_id, secret, service_name, **kwargs)
        self.method = 'GET'
        self.path = 'payments'
